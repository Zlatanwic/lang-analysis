  ...
  series: [
    {
      ...
      itemStyle: { color: '#9fe870', borderRadius: [8, 8, 0, 0] },
      emphasis: { itemStyle: { color: '#cdffad' } },
    },
    {
      name: '5年移动平均',
      type: 'line',
      ...
      lineStyle: { width: 3, color: '#054d28' },
    ...
    },
    {
      ...
      lineStyle: { width: 2, color: '#454745' },
      areaStyle: { color: 'rgba(69, 71, 69, 0.08)' },
    },
  ],
}))
</script>
